...
import com.xr6software.digitalwallet.databinding.ActivityLoginBinding
import com.xr6software.digitalwallet.model.UserSingleton
import com.xr6software.digitalwallet.utils.MessageFactory
import com.xr6software.digitalwallet.viewmodel.LoginActivityViewModel
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun showCreateUserDialog() {
        ...
        okButton.setOnClickListener {
            viewModel.insertNewUser(viewBinding.maEdittxtUser.text.toString(), viewBinding.maEdittxtPass.text.toString())
    ...
    private fun validateUserInputEditText(edittext : EditText) : Boolean{
        return (edittext.text.toString().length >= MIN_CHARS) && (edittext.text.toString().length <= MAX_CHARS)
    }
