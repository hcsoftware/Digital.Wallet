...
import com.xr6software.digitalwallet.network.APIService
...
class PaymentViewModel : ViewModel() {
    ...
    /**
     * This method requests the qr Bitmap from the ApiService, on success loads Bitmap in BitmapResponse LiveData.
     * Handles loading an error vars.
     */
    fun loadQrCodeApiService(amount: String, size: Int){

        isLoading.value = true
        apiService.loadQRCodeFromApi(amount, size, object : com.xr6software.digitalwallet.network.Callback<Response> {
